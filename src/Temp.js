...
import "./App.css";
import LeftMenu from "./components/home/leftsection/LeftMenu";
          ...
          <div id="right-menu" className="h-5/6 w-2/1 fixed">
            <div className="mt-3 mb-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 ">
                Ullamco magna in ipsum velit consequat in aute anim et. Non
                nostrud adipisicing magna sunt duis excepteur culpa non sit
